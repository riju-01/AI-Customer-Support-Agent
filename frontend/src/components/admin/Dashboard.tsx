...
import type { Session, ReasoningLogEntry } from "@/lib/types";
      ...
      <div className="w-80 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex flex-col">
        ...
        <div className="p-5 border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="flex gap-2">
            <div className="flex-1 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
